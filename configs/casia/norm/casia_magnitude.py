class cfg:
    ...
    output ="../Output/magnitude/casia_arcface_0.5_magnitude_0.1" #"Output/ms1mv3" _tanface_0.7_1_grad ms1mv3_arcFace_forward_back_s
    scale_constraint=0.1
    scale_constraint_lambda_scale=1
    rec = "../Data/casia-webface.pickle" # "../Data/ms1mv3"
    val = "../Data/test"
    num_classes = 10573
    num_image = 490623
    num_epoch = 20
