class cfg:
    ...
    teacher_ouput='../Output/best/casia_powerface_0.7_20_1'
    output ="../Output/casia_student_ratio_loss_X5" #"Output/ms1mv3" _tanface_0.7_1_grad ms1mv3_arcFace_forward_back_s
