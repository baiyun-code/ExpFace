...
class cfg:
    ...
    output =f"../../Output/ms1mv3_arcface_loss_{loss_name}_s_{s}_m_{m}_samplerate_{sample_rate}" #"Output/ms1mv3" _tanface_0.7_1_grad ms1mv3_arcFace_forward_back_s
