...
class cfg:
    ...
    s=32.0
    m=1.7
    margin_loss = SphereFace(s=s,m=m)
    ...
    output =f"../../Output/ms1mv3_sphereface_loss_{loss_name}_s_{s}_m_{m}" #"Output/ms1mv3" _tanface_0.7_1_grad ms1mv3_arcFace_forward_back_s
