...
class cfg:
    ...
    loss_name = "Unified_Cross_Entropy_Loss_CosFace"  # "my_CE"  "PFC" "my_CE_logexp" "my_CE_logexp1" "my_CE_logexp2"
    ...
    output =f"../../Output/ms1mv3_cosface_loss_{loss_name}_s_{s}_m_{m}" #"Output/ms1mv3" _tanface_0.7_1_grad ms1mv3_arcFace_forward_back_s
