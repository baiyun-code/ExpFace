...
class cfg:
    ...
    loss_name = "PFC"  # "my_CE"  "PFC" "my_CE_logexp" "my_CE_logexp1" "my_CE_logexp2"
    ...
    output =f"../../Output/ms1mv3_expface_loss_{loss_name}_s_{s}_m_{m}_samplerate_{sample_rate}" #"Output/ms1mv3" _tanface_0.7_1_grad ms1mv3_arcFace_forward_back_s
