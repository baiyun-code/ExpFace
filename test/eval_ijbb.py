...
# general
# parser.add_argument('--model-prefix', default=cfg.output + "/model.pt", help='path to load model.')
# parser.add_argument('--image-path', default=cfg.val + '/ijb/IJBB', type=str, help='')
# parser.add_argument('--result-dir', default=cfg.output, type=str, help='')
# parser.add_argument('--batch-size', default=cfg.batch_size, type=int, help='')
# parser.add_argument('--network', default=cfg.network, type=str, help='')  #iresnet50
...
parser.add_argument('--config', default="casia.casia", help='the name of config file')
...
# Save tpr_fpr_table to a text file
with open(os.path.join(save_path, '%s_tpr_fpr_table.txt' % target.lower()), 'w') as f:
